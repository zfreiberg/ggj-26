...
public class EnemyAIPatrol : MonoBehaviour
{
    ...
    [SerializeField] LayerMask groundLayer = ~0; // default: everything (to set in editor - should set to "Ground)
    ...
    [SerializeField] float checkAtWallDistance = 1f; // distance for wall check raycast
